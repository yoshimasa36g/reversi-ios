...
final class PlayersTests: XCTestCase {
    ...
    func testStartOperationWhenDarkPlayersTurn() {
        subject.startOperation(gameState: GameState(turn: .dark), onStart: {}, onComplete: { _ in })
    ...
    func testStartOperationWhenLightPlayersTurn() {
        subject.startOperation(gameState: GameState(turn: .light), onStart: {}, onComplete: { _ in })
